...
parfor i=1:iter
    ...
    %Beam and Mass 1
    x1 = q(1)*feval(Phi,feval(Beam,L1),L1);
    y1 = feval(Beam,L1);
    ...
    %Beam and Mass 2
    x2 = q(2)*feval(Phi,feval(Beam,L2),L2)+x1(end);
    ...
    %Beam and Mass 3
    x3 = q(3)*feval(Phi,feval(Beam,L3),L3)+x2(end);
    ...
    %Beam and Mass 4
    x4 = q(4)*feval(Phi,feval(Beam,L4),L4)+x3(end);
    ...
    %Blades
    % 1
    x5 = (q(5)*feval(Phi,feval(Beam,L5),L5))*cos(feval(ang,time(i))) +  (feval(Beam,L5))*(-sin(feval(ang,time(i)))) + x4(end) - sin(feval(ang,time(i)))*rhub;
    y5 = (q(5)*feval(Phi,feval(Beam,L5),L5))*sin(feval(ang,time(i))) +  (feval(Beam,L5))*cos(feval(ang,time(i))) + y4(end) + h + cos(feval(ang,time(i)))*rhub;
    plot(x5,y5,'linewidth',3,'color','m')
    plot(x5,y5,'linewidth',3,'color','m')
    
    % 2
    x6 = (-q(6)*feval(Phi,feval(Beam,L6),L6))*cos(feval(ang,time(i))-pi) +  (feval(Beam,L5))*(-sin(feval(ang,time(i))-pi)) + x4(end) + sin(feval(ang,time(i)))*rhub;
    y6 = (-q(6)*feval(Phi,feval(Beam,L6),L6))*sin(feval(ang,time(i))-pi) +  (feval(Beam,L5))*cos(feval(ang,time(i))-pi) + y4(end) + h - cos(feval(ang,time(i)))*rhub;
